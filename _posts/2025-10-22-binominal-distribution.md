...
> - 누적확률은 **보완사건**으로 빠르게 계산: \(P(X\ge a)=1-P(X\le a-1)\)
...
- **분산**  
  \[
  \sigma^2=\sum_k (k-\mu)^2p_X(k)=E[X^2]-(E[X])^2
  \]
...
- **순열**: \(P(n,k)=\dfrac{n!}{(n-k)!}\) (**순서 중요**)  
- **조합**: \(\displaystyle \binom{n}{k}=\dfrac{n!}{k!(n-k)!}\) (**순서 무관**)
...
- 배경: 이항분포는 두 가지 사건만 가능한 시행(예: 동전 던지기)에 쓰이며, 조건에 따라 **정규분포로 근사**되어 정규 이해의 징검다리가 됨  
...
### \(n=10,\ p=0.05\)
![n10p005](/assets/img/binom-n10-p005.png)

### \(n=10,\ p=0.95\)
![n10p095](/assets/img/binom-n10-p095.png)

### \(n=10,\ p=0.50\)
![n10p050](/assets/img/binom-n10-p050.png)
...
- 누적확률은 **보완사건** 활용: \(P(X\ge a)=1-P(X\le a-1)\)
